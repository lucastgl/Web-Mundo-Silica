  ...
  return (
    <button
      className={cn(
        ...
        variant === "default" && "bg-[#01959e] text-white hover:bg-[#01959e]/90",
        variant === "destructive" && "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        variant === "outline" && "bg-transparent border-2 border-[#01959e] text-[#01959e] hover:bg-accent hover:text-accent-foreground",
